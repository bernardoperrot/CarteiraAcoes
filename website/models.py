...
class Usuario(db.Model, UserMixin):
    ...
    carteira_stock = db.relationship('CarteiraStock')
    stock = db.relationship('Stock')
    hist_stock = db.relationship('HistStock')
    compra_stock = db.relationship('CompraStock')
